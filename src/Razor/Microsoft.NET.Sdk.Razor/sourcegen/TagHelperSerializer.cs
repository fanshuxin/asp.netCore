...
namespace RazorSourceGenerators
{
    ...
    {
        public const string ReferenceAssemblyTagHelpersOutputPath = "RazorTagHelper.refs.out.cache";
        public const string CurrentAssemblyTagHelpersOutputPath = "RazorTagHelper.out.cache";
